  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_middle:
          "aria-selected:bg-primary/20 aria-selected:text-primary-foreground hover:bg-primary/30",
